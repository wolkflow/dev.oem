 ...
 */
class wolk_oem extends CModule
{
    // Настройки модуля.
    var $MODULE_ID              = 'wolk.oem'; // Без var не пускает в маркетплейс.
     ...
     */
    public function wolk_oem()
    {
        global $APPLICATION, $DOCUMENT_ROOT;
        
        $this->MODULE_NAME           = GetMessage('WOLK_OEM_MODULE_NAME');
        $this->MODULE_DESCRIPTION    = GetMessage('WOLK_OEM_MODULE_DESC');
