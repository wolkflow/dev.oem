...
ru_octasoft_oem_designer_Grid.prototype = $extend(openfl_display_Sprite.prototype,{
	...
	,add: function(item,x,y,rotation,lift) {
		...
		if(figure.type == ru_octasoft_oem_designer_ItemType.shelf) figure.set_lift(lift);
