...
$MESS['SKETCH_HELP_TEXT'] = 'Для расстановки оборудования на стенде перетащите все оборудования из левого столбца на скетч.<br/><br/>
Вы можете очистить скетч при помощи кнопки очистки в виде стрелки.<br/>
Вы можете удалить объект, выделив нужный обхект и нажав крестик в верхней панели.<br/>
При помощи стрелок вы можете вернуться на шаг назад или вперед.<br/>
Также Вы можете приблизить или отдалить сцену при помощи кнопок масштаба.<br/>
Для поворота объекта выедлите объект и потащите за угол рамки.
';
