					...
					<tr valign="top">
						<td style="padding-top: 52px;padding-bottom: 50px;background-image: url('http://<?= SITE_SERVER_NAME ?>/upload/mail/images/mid.png');background-repeat: repeat-y;padding-right: 61px;padding-left: 61px;">
							...
							<p style="margin: 0;padding: 0;font-size: 15px;font-family: 'GothamPro', Arial, Helvetica, sans-serif;line-height: 24px;color: #333333;">
								Статус вашего заказа для выставки <?= $arResult['EVENT']['NAME'] ?> изменён.
								Следить за состоянием заказа вы можете в личном кабинете системы.
							</p>
							...
							<table cellpadding="0" cellspacing="0" border="0" style="margin: 0;padding: 0;width: 100%">
								<tr>
									<td style="padding-top: 53px;padding-bottom: 1px;">
										...
										<p style="margin: 0;padding: 23px 0 23px 0;font-size: 15px;font-family: 'GothamPro', Arial, Helvetica, sans-serif;text-transform: uppercase;color: #333333;line-height: 1px">
											текущий статус заказа: <b><?= $arResult['STATUSES'][$arResult['ORDER']['STATUS_ID']]['NAME'] ?></b>
										</p>
										<div><img style="display: block;" src="http://<?= SITE_SERVER_NAME ?>/upload/mail/images/line.png" /></div>
									</td>
								</tr>
								<tr>
									<td style="padding-top: 58px;padding-bottom: 7px;">
										<a href="http://<?= SITE_SERVER_NAME ?>/personal/profile/" style="display: block;height: 60px;font-size: 17px;font-family: 'GothamPro', Arial, Helvetica, sans-serif;text-transform: uppercase;color: #ffffff;font-weight: 700;text-align: center;line-height: 60px;text-decoration: none;width: 100%;background-color: #7f7f7f;">войти в личный кабинет</a>
									</td>
								</tr>
							</table>
