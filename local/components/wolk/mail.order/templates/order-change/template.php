							...
							<table cellpadding="0" cellspacing="0" border="0" style="margin: 0;padding: 0;width: 100%">
								<tr>
									<td>
										...
										<p style="margin: 0 0 51px 0;padding: 0;font-size: 15px;font-family: 'GothamPro', Arial, Helvetica, sans-serif;line-height: 24px;color: #333333;">
											Вы внесли изменения в заказ оборудования для выставки <?= $arResult['EVENT']['NAME'] ?>.
											Новые данные приняты и сохранены в системе, с деталями вы можете ознакомиться ниже.
										</p>
								...
								<tr>
									<td>
										...
										<img src="http://<?= SITE_SERVER_NAME ?><?= $arResult['SKETCH'] ?>" style="display: block;margin-bottom: 4px;max-width: 100%;" />
									</td>
								</tr>
