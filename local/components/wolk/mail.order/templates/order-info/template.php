					...
					<tr valign="top">
						<td style="padding-top: 52px;padding-bottom: 50px;background-image: url('http://<?= SITE_SERVER_NAME ?>/upload/mail/images/mid.png');background-repeat: repeat-y;padding-right: 61px;padding-left: 61px;">
							<table cellpadding="0" cellspacing="0" border="0" style="margin: 0;padding: 0;width: 100%">
								<tr>
									<td>
										...
										<p style="margin: 0 0 51px 0;padding: 0;font-size: 15px;font-family: 'GothamPro', Arial, Helvetica, sans-serif;line-height: 24px;color: #333333;">
											Благодарим вас за заказ в онлайн-конфигураторе выставки <?= $arResult['EVENT']['NAME'] ?>. 
											Ниже вы можете просмотреть детали вашего заказа и при необходимости отредактировать его в личном кабинете.
										</p>
								...
								<tr>
									<td>
										<p style="border-bottom: 3px solid #7f7f7f;margin: 115px 0 30px 0;padding: 0 0 25px 0;font-size: 21px;font-family: 'GothamPro', Arial, Helvetica, sans-serif;font-weight: 700;color: #333333;text-transform: uppercase">Схема расстановки оборудования</p>
										<img src="<?= $arResult['SKETCH'] ?>" style="display: block;margin-bottom: 4px;max-width: 100%;" />
									</td>
								</tr>

								<tr>
									<td>
										<a href="http://<?= SITE_SERVER_NAME ?>/personal/orders-history.php" style="display: block;font-size: 17px;font-family: 'GothamPro', Arial, Helvetica, sans-serif;text-transform: uppercase;color: #ffffff;font-weight: 700;text-align: center;text-decoration: none;width: 100%;background-color: #7f7f7f;margin-top: 56px;margin-bottom: 60px;padding-top: 29px;padding-bottom: 30px;line-height: 1px;">
											изменить заказ
										</a>
									</td>
								</tr>
